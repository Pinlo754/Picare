          ...
          <div>
            <div className="flex items-center justify-between h-[176px]">
                ...
                >
                  <div className="flex">
                    <ul className="w-[80%] bg-white h-screen flex flex-col">
                      ...
                      <div className="flex">
                        <div className="w-[50%] bg-[#f4f4f4] h-10 flex items-center justify-center gap-2 border">
              ...
              <div className="relative mr-5 z-0">
                ...
                <span className="absolute rounded bottom-4 left-4 text-xs bg-green-500 text-white w-4 h-4 flex items-center justify-center z-10">
                  1
                </span>
              </div>
            </div>
