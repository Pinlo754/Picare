    ...
    return (
        <>
            ...
            <div className={"grid place-items-center"}>
                <h2 className={"text-2xl text-center mb-1 mt-5 font-title"}>CHĂM TÓC CHUẨN SALON</h2>
            ...
            {/*Sản Phẩm Nổi Bật */}
            <div className={"grid place-items-center"}>
                <h2 className={"text-2xl font-title text-center mb-1 mt-5"}>Sản Phẩm Nổi Bật</h2>
                <div className="grid grid-cols-2 sm:grid-cols-2 gap-2 p-4">
                    <Product
                        brand={"CANOVA"}
                        title={"Dầu Gội Canova Làm Dịu Da Ngừa Tiết Bã Nhờn Dành Cho Da Gàu Kích Ứng Rivescal DS Soothing ShampooI 200ml"}
            ...
            {/*Sản Phẩm Độc Quyền */}
            <div className={"grid place-items-center"}>
                <h2 className={"text-2xl font-title text-center mb-1 mt-5"}>Sản Phẩm Độc Quyền</h2>
                <div className="grid grid-cols-2 sm:grid-cols-2 gap-2 p-4">
                    <Product
                        brand={"CANOVA"}
                        title={"Dầu Gội Canova Làm Dịu Da Ngừa Tiết Bã Nhờn Dành Cho Da Gàu Kích Ứng Rivescal DS Soothing ShampooI 200ml"}
